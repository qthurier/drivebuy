...
/**
 * Created by delavegas on 09/05/16.
 */
...
public class LiteListDemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<HarryAppTask> tasks = (ArrayList<HarryAppTask>) getIntent().getSerializableExtra("tasks");
        // Set a custom list adapter for a list of locations
        //mAdapter = new MapAdapter(this, LIST_LOCATIONS);
        mAdapter = new MapAdapter(this, tasks);
     ...
     */
    private class MapAdapter extends ArrayAdapter<HarryAppTask> {

        private final HashSet<MapView> mMaps = new HashSet<MapView>();

        public MapAdapter(Context context, ArrayList<HarryAppTask> locations) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            HarryAppTask item = getItem(position);
            ...
            holder.title.setText(item.asRoute());
    ...
    private static void setMapLocation(GoogleMap map, HarryAppTask task) {
        // Add a marker for this item and set the camera
        map.addMarker(new MarkerOptions().position(task.deliveryLocation).icon(BitmapDescriptorFactory.fromResource(R.drawable.flag)));
        map.addMarker(new MarkerOptions().position(task.pickupLocation).icon(BitmapDescriptorFactory.fromResource(R.drawable.parcel)));
        LatLngBounds.Builder builder = new LatLngBounds.Builder();
        builder.include(task.deliveryLocation);
        builder.include(task.pickupLocation);
    ...
    class ViewHolder implements OnMapReadyCallback {
        ...
        public void onMapReady(GoogleMap googleMap) {
            ...
            HarryAppTask data = (HarryAppTask) mapView.getTag();
            if (data != null) {
